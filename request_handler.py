...
from views import get_all_animals, get_single_animal, create_animal, delete_animal\
    , update_animal, get_all_locations, create_location, get_single_location\
    , delete_location, update_location, get_all_customers, get_single_customer\
    , create_customer, delete_customer, update_customer, get_all_employees\
